import { filterMeetings } from '../services/get-meetings';
import { getUserID } from '../services/get-id';
class displayFilter {
    constructor() {
        this.allUsers = [];
        this.searchMeetingForm = null;
        this.showMeetings = (meetings) => {
            ...
            meetings.forEach(function (meeting) {
                ...
                let year = meeting.date[0] + meeting.date[1] + meeting.date[2] + meeting.date[3];
        ...
        this.showSearchMeetings = () => {
            this.searchMeetingForm.addEventListener("submit", (event) => {
        ...
        this.load = () => {
            this.searchMeetingForm = document.getElementById("search-meeting-form");
            this.getAllUsers();
            this.showSearchMeetings();
        };
    }
...
//# sourceMappingURL=display-filter-meetings.js.map